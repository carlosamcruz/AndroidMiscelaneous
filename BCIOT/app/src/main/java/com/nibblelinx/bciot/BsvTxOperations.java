...
/*
                txID(Variables.ArduinoLastTX);
                if(TXIDhere.compareTo(TXID)==0)
                {
                    JsonTaskTXIDNew(urlBaseTXID); //so para emular atraso
                    TxHexData = Variables.ArduinoLastTX;
                }
                else
                ...
                */
                ...
                /*
                    ...
                    if(TxHexData.substring(0,1).compareTo("0")!=0)
                    {
                        //byte[] TxByte = new byte[TxHexData.length()];
                        ...
                        //byte[] TxByte = TxHexDataSent.getBytes();

                        //TxHexData = SHA256G.ByteToStrHex(TxByte);

                        //Variables.txBitaisl = TxHexData;

                        //Variables.txBitaisl = SHA256G.ByteToStrHex(SHA256G.StrToByte(TxHexData))  + "\n" + TxHexData.length();
                        Variables.txBitaisl = PDPUtils.strToHEXStr(TxHexData)  + "\n" + TxHexData.length();
                ...
                String debug0 = "";
                Variables.txBitaisl = SHA256G.ByteToStrHex(TxByte);
                TxHexData = debug0;
                */
    ...
    public void readHexBsvTx(String TXID1){
...
//        threadEndBroadcastHexBsvTx = false;
        ...
        //Variables.ArduinoLastTX = TxHexBsv;
...
///////////////////////////////////////////////////////////////////////////////////
    ...
    public String txID2 (String txHexData)
    {
        String txID = SHA256G.SHA256bytes(
                SHA256G.HashStrToByte2(txHexData)
        );
...
//            preImage41parts = preImage41parts + TxidTosearch + "\n"  + pvOutIndexCurrent[i] + "\n";
            ...
            /*
            if(txID2(Variables.ArduinoLastTX).compareTo(TxidTosearch)==0)
            {
                TxHexData = Variables.ArduinoLastTX;
                //return TXToSeach;
            }
...
//            timer.purge();
            ...
            if(TxHexData == null) {
                String[] TxPreimageOutFail = new String[1];
                TxPreimageOutFail[0] = "Error: Time out reading TX HEX DATA" + TxidTosearch;
                return TxPreimageOutFail;
            }
            /*
