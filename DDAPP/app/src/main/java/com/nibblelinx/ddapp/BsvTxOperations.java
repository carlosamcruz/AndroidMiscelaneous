...
//
// OBS: Código não sync com versão do BCAPP por conta das variáveis globais
//
/////////////////////////////////////////////////////////////////
...
//                returnDataNew = Out1Script.substring(4) + "75"; // Funcionou com a otimização
                                 ...
                                 String inputPreString, int TXType)
    {
        ...
        Variables.TestString = Variables.TestString
                + "\n" + totalOutString;
        //return  inputPreString + totalOutString;
        return  totalOutString;
    }
...
///////////////////////////////////////////////////////////////////////////////////
    ...
    public String txSigVerify (String preImage, String pubKeySEC, String sigDER41)
    {
        ...
        //From the site: não confere
        //e = "479f9dff0155c045da78402177855fdb4f0f396dc0d2c24f7376dd56e2e68b05";

        Variables.preimageE = preImage + "\n\n"+ e + "\n\nlength: " + preImage.length()
                +"\n\nSig: "+ sigDER41
                +"\n\n"+ sigDERrev[0] + "\n\n"+ sigDERrev[1]
                + "\n\nPUBK: "+ pubKeySEC
                +"\n\n"+ pubKeyREV[0] + "\n\n"+ pubKeyREV[1]
