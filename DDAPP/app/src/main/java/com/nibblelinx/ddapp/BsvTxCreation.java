...
///////////////////////////////////////////////////////////////////////////////
    public Boolean txVerify(String txToVerify)
    {
        ...
        //First Signature
        Variables.txParts = "";
        for(int i =0 ; i < bsvTX.totalElements; i ++) {
            Variables.txParts = Variables.txParts + TXPartes41[i] + "\n\n";

            //Only for Satohis Key;
            if(pubKeySEC41[0].length() == 0) pubKeySEC41[0] = "410411db93e1dcdb8a016b49840f8c53bc1eb68a382e97b1482ecad7b148a6909a5cb2e0eaddfb84ccf9744464f82e160bfa9b8b64f9d4c03f999b8643f656b412a3";
        ...
        */
        ...
        //primeiras TX String  sighashType = "01000000";
        //preImage41[0] = txToVerify.substring(0, txToVerify.length() - 1) + "01000000";
        ...
        // Script output que esta sendo gasto
        ...
        //
        /*
        preImage41[0] = "";
        preImage41[0] = TXPartes41[0] + TXPartes41[1] + TXPartes41[2] + TXPartes41[3]+
                "43410411db93e1dcdb8a016b49840f8c53bc1eb68a382e97b1482ecad7b148a6909a5cb2e0eaddfb84ccf9744464f82e160bfa9b8b64f9d4c03f999b8643f656b412a3ac"
                + TXPartes41[7] + TXPartes41[8] + TXPartes41[9] + TXPartes41[10] + TXPartes41[11]
                + TXPartes41[12] + TXPartes41[13] + TXPartes41[14] + TXPartes41[15] + "01000000";
        */
